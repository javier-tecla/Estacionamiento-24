        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Registro de una tarifa</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="nombre" id="nombre" required>
                                            ...
                                            <option value="regular" {{ old('nombre') == 'regular' ? 'selected' : '' }}>
                                                Tarifa Regular</option>
                                            <option value="nocturna" {{ old('nombre') == 'nocturna' ? 'selected' : '' }}>
                                                Tarifa Nocturna</option>
                                            <option value="fin_de_semana"
                                                {{ old('nombre') == 'fin_de_semana' ? 'selected' : '' }}>Fin de Semana
                                            </option>
                                            <option value="feriados" {{ old('nombre') == 'feriados' ? 'selected' : '' }}>
                                                Feriados</option>
                                        </select>
                                    </div>
                                    @error('nombre')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="tipo" id="tipo" required>
                                            ...
                                            <option value="por_hora" {{ old('tipo') == 'por_hora' ? 'selected' : '' }}>Por Hora</option>
                                            <option value="por_dia" {{ old('tipo') == 'por_dia' ? 'selected' : '' }}>Por Día</option>
                                        </select>
                                    </div>
                                    @error('tipo')
                                        <small style="color: red">{{ $message }}</small>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control" type="number" name="cantidad" id="cantidad"  min="0" required value="{{ old('cantidad') }}">
                                    </div>
                                    @error('cantidad')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control" type="number" name="minutos_de_gracia" id="minutos_de_gracia"  min="0" required value="{{ old('minutos_de_gracia') }}">
                                    </div>
