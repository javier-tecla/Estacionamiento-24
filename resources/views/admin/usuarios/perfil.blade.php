            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><b>Información personal</b></h3>
                        <!-- /.card-tools -->
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nombres" id="nombres"
                                                    value="{{ old('nombres', $usuario->nombres) }}" placeholder="Nombres"
                                                    required>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="email">Correo Electrónico <sup
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Tipo de Documento <sup
                                                    class="text-danger">(*)</sup></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                ...
                                                <select class="form-control" name="tipo_documento" id="tipo_documento"
                                                    ...
                                                    <option value="Carnet de Extranjería"
                                                        {{ old('tipo_documento', $usuario->tipo_documento) == 'Carnet de Extranjería' ? 'selected' : '' }}>
                                                    ...
                                                    <option
                                                        value="CI"{{ old('tipo_documento', $usuario->tipo_documento) == 'CI' ? 'selected' : '' }}>
                                                        CI
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="celular" id="celular"
                                                    value="{{ old('celular', $usuario->celular) }}" placeholder="Celular"
                                                    required>
                                            </div>
                                            @error('celular')
                                                <small style="color: red">{{ $message }}</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="direccion"
                                                    id="direccion" value="{{ old('direccion', $usuario->direccion) }}"
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control" name="password_actual"
                                            id="password_actual" placeholder="Ingresa tu contraseña actual">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control" name="password_nueva"
                                            id="password_nueva" placeholder="Ingresa tu nueva contraseña" >
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="password_actual">Confirmar Nueva Contraseña</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-shield-alt"></i></span>
                                        </div>
                                        <input type="password" class="form-control" name="password_confirmacion"
                                            id="password_confirmacion" placeholder="Confirma tu nueva contraseña">
                                    </div>
